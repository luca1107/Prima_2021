namespace SpaceInvaders {
  ...
  export class QuadNode extends ƒ.Node {
    ...
    public setRectPosition(_parentPos : ƒ.Vector2 ):  void
    {
      this.rect.position.x = (this.mtxLocal.translation.x +_parentPos.x) - this.rect.size.x/2;
      this.rect.position.y = (this.mtxLocal.translation.y +_parentPos.y) - this.rect.size.y/2;
    }

    public setRectPositionWithoutParent():  void
    {
